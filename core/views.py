...
from .models import Item, OrderItem, Order, Address, Payment, Coupon, Carrousel, Category, Refund
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            messages.warning(
                self.request, "Something weng wrong. You were not charged. Please try again.")
            return redirect("/")
